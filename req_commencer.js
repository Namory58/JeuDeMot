...
const trait = function (req, res, query) {
  ...
  let indexAleatoire = Math.floor(Math.random() * mots.mots.length); // chercher l'index du mot
  let motAleatoire = mots.mots[indexAleatoire];
  ...
  motgenerate.motSearch = utile.spacemot(motAleatoire).join(" ");
  ...
  marqueurs = {};
  marqueurs.mot = motgenerate.motSearch;
